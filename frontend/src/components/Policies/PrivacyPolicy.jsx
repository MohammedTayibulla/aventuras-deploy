    ...
    <div className="privacy-policy-page-container">
        <div className="privacy-policy-page-wrapper">
            ...
            <div className="privacy-policy-text-container">
                ...
                <div className="para">
                This Privacy Policy pararibes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
                </div>
                <div className="para">
                    ...
                    <div className="list-container">
                        ...
                        <ul className="list-wrapper">
                            ...
                            <li className="list-items">
                                ...
                                (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Aventuras Holidays LLP, #15/2, S type housing colony, Adityapur, Jamshedpur.
                            ...
                            <li className="list-items">
                                ...
                                refers to Aventuras, accessible from <Link to="https://www.aventuras.co.in/" className='link-address'>aventuras.co.in</Link>
                                </li>
...
Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the Free Privacy Policy website article.
 ...
 <div className="para">
 We use both Session and Persistent Cookies for the purposes set out below: </div>
...
The Company may use Personal Data for the following purposes:
  ...
  <ul className="list-wrapper">
      ...
      <li className="list-items">
      By email: hello@aventuras.co.in
         </li>

         <li className="list-items">
         By phone number: 9800010016
         </li>
